  ...
  <div class="video__container text-white text-center">
    ...
    <div style="position: relative; display: inline-block;">
      ...
      <a
        ...
        target="_blank"
        style="position: absolute; top: 35px; left: 130px; background-color: rgba(0,123,255,0.9); color: white; padding: 5px 10px; border-radius: 4px; font-size: 12px; text-decoration: none;"
      >
        MH67689
      </a>
    </div>
