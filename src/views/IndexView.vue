...
<template>
  <div class="video__container text-white text-center">
    ...
    <video muted autoplay controls loop playsinline class="video__element" ref="reproductor" @canplay="handleCanPlay" :style="{ display: videoVisible ? 'block' : 'none' }">
     ...
     <img loading="lazy" class="w-full aspect-square" src="https://lawngreen-wallaby-976278.hostingersite.com/wp-content/uploads/2024/08/yyyy22.png" style="width: 1400px; height: 164px; object-fit: cover; margin-top: 20px; margin-bottom: 20px; margin-left: 20px; margin-right: 20px;" />
    </div>
    <div class="relative">
