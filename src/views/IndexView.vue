...
<template>
  ...
  <div class="flex flex-wrap justify-center gap-8 text-lg"> <!-- flex-wrap para que se adapten en pantallas pequeñas -->
    <!-- Cada certificación tiene un ancho máximo en función de la pantalla -->
    <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4"> <!-- px-4 para margen entre las certificaciones -->
